...
const templateFragment = document.querySelector('#card').content.querySelector('article');

const createTitlePopup = (offer, cardElement) => {
...
const createAdressPopup = (offer, cardElement) => {
...
const createPricePopup = (offer, cardElement) => {
...
const createTypePopup = (offer, cardElement) => {
...
const createCapacityPopup = (offer, cardElement) => {
...
const createTimePopup = (offer, cardElement) => {
...
const createFeaturesPopup = (offer, cardElement) => {
...
const createDescriptionPopup = (offer, cardElement) => {
...
const createPhotosPopup = (offer, cardElement) => {
...
const createAvatarPopup = (offer, cardElement) => {
...
const createPopup = (offer) => {
  ...
  createTitlePopup(offer, cardElement);
  createPhotosPopup(offer, cardElement);
  createDescriptionPopup(offer, cardElement);
  createFeaturesPopup(offer, cardElement);
  createTimePopup(offer, cardElement);
  createCapacityPopup(offer, cardElement);
  createTypePopup(offer, cardElement);
  createAdressPopup(offer, cardElement);
  createAvatarPopup(offer, cardElement);
  createPricePopup(offer, cardElement);
  return cardElement;
};
